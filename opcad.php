...
<img src="23.jpg" width="550" height="170">
    ...
    <fieldset>
       ...
       <!-- <legend><b>Cadastro de estabelecimento</b></legend>
        ...
        <input type="radio" id="container" name="Tipo" value="cadastro" required onclick="loadPage()">
        <label for="container">Cadastro de container</label>

        <br>
        <br>


        <input type="radio" id="doadores" name="Tipo" value="doadores" required onclick="loadPage()">
        <label for="dev">Cadastro de doadores</label>
...
function loadPage() {
    if(document.getElementById('doadores').checked) {
        window.location.href = "form.php";
    } else if(document.getElementById('container').checked) {
