<?php
    ...
    $result = mysqli_query($con1, "INSERT INTO c.aloc (estabelecimento, nomecond, cnpj, email, Endereco, telefone, Dataalug, coletacon)
    VALUES ('$tipo','$nome', '$cnpj', '$email', '$endereco', '$telefone', '$data_cad', '$coleta')");
...
if((isset($_SESSION['email']) == true) and (!isset($_SESSION['senha']) == true)){
    ...
    $sql="SELECT * FROM c.aloc ORDER BY id DESC";
